...
if(!require(shiny)){
  ...
  library(withr)
  #withr::install_github("trestletech/ShinyDash")
  #withr::install_github("rstudio/shiny-incubator")
  with_libpaths(new = "C://Users//16196//Documents//R//library//muxViz//", install_github("trestletech/ShinyDash"))
  with_libpaths(new = "C://Users//16196//Documents//R//library//muxViz//", install_github("rstudio/shiny-incubator"))
}else{
...
if(!require(d3heatmap)){
  ...
  #with_libpaths(new = "C://Users//16196//Documents//R//library//muxViz//", install_github("rstudio/d3heatmap"))
}
if(!require(ggplot2)){
...
if(!require(rCharts)){
  ...
  #with_libpaths(new = "C://Users//16196//Documents//R//library//muxViz//", install_github("ramnathv/rCharts"))
}
